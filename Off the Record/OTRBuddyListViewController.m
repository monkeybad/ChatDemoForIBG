...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self.view bringSubviewToFront:_groupBtn];
}
...
#pragma mark - Group Talk

- (void)_onPressedGroupTalkButton
{
    GroupTalkListViewController* ctrl = [[GroupTalkListViewController alloc] initWithNibName:@"GroupTalkListViewController" bundle:nil];
    [self.navigationController presentViewController:ctrl animated:YES completion:nil];
}

- (void)_createGroupTalkButton
{
    ...
    [button setTitle:@"Group Talk" forState:UIControlStateNormal];
    [button addTarget:self action:@selector(_onPressedGroupTalkButton) forControlEvents:UIControlEventTouchUpInside];
